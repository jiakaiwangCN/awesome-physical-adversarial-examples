...
<p align="center">
<img src="./Imgs/roadmap.png" width="90%" />
</p>
...
[🔥] *indicates citation number*, *and* [⭐] *indicates Github star number*.   
****

<!-- ## Surveys
- \[**`2026`**\][[Neurocomputing]](https://www.sciencedirect.com/science/article/abs/pii/S0925231225031571) A survey on physical adversarial attacks against face recognition systems
...
- \[**`2022`**\][[NeurIPS](https://arxiv.org/pdf/2210.15291.pdf)] Isometric 3D Adversarial Examples in the Physical World [**`3D`**]
...
- \[**`2022`**\][[NeurIPS](https://papers.nips.cc/paper_files/paper/2022/file/c204d12afa0175285e5aac65188808b4-Paper-Conference.pdf)] VoiceBlock: Privacy through Real-Time Adversarial Attacks with Audio-to-Audio Models \[**`Audio/Speech`**\][[Code](https://github.com/voiceboxneurips/voicebox)]
...
- \[**`2020`**\]\[[NeurIPS](https://arxiv.org/pdf/2002.03500.pdf)\][55:fire:] Watch out! Motion is Blurring the Vision of Your Deep Neural Networks \[**`Lighting`**\][[Code](https://github.com/tsingqguo/ABBA)]
...
- \[**`2019`**\]\[[NeurIPS](https://arxiv.org/pdf/1911.00126.pdf)\][57:fire:] Adversarial Music: Real World Audio Adversary Against Wake-word Detection System [**`Audio/Speech`**]
...
- \[**`2025`**\][[IEEE TAP]](Adversarial Attack Method Against SAR ATR Based on Superimposed Phase Modulation) Adversarial Attack Method Against SAR ATR Based on Superimposed Phase Modulation \[**`Radar`**\]
- \[**`2025`**\][[JCRD]](https://arxiv.org/abs/2211.10661) Phonemic Adversarial Attack Against Audio Recognition in Physical World \[**`Audio/Speech`**\]
...
- \[**`2019`**\][[NeurIPS](https://arxiv.org/pdf/1911.00126.pdf)\][57:fire:] Adversarial Music: Real World Audio Adversary Against Wake-word Detection System
...
- \[**`2025`**\][[AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/32555)] Adversarial Attacks on Event-Based Pedestrian Detectors: A Physical Approach
...
- \[**`2024`**\][[NeurIPS](https://proceedings.neurips.cc/paper_files/paper/2024/hash/0f5cb62a8e3331b253c232e229cd551e-Abstract-Conference.html)] Revisiting Adversarial Patches for Designing Camera-Agnostic Attacks against Person Detection
...
- \[**`2022`**\][[NeurIPS](https://arxiv.org/pdf/2210.03895.pdf)] Viewfool: Evaluating the robustness of visual recognition to adversarial viewpoints [[Code](https://github.com/Heathcliff-saku/ViewFool_)]
...
- \[**`2022`**\][[NeurIPS](https://arxiv.org/pdf/2210.06871.pdf)] Adv-attribute: Inconspicuous and transferable adversarial attack on face recognition [**`Generative`**]
...
- \[**`2025`**\][[PRL]](https://journals.aps.org/prd/abstract/10.1103/PhysRevD.112.016004) Enhancing generalization in high-energy physics using white-box adversarial attacks [**`Optimization-based`**]
- \[**`2025`**\][[arXiv]](https://arxiv.org/abs/2506.09538) AngleRoCL: Angle-Robust Concept Learning for Physically View-Invariant T2I Adversarial Patches [**`Optimization-based`**]
- \[**`2026`**\][[arXiv]](https://arxiv.org/abs/2602.18739) When World Models Dream Wrong: Physical-Conditioned Adversarial Attacks against World Models [**`Optimization-based`**]
...
- \[**`2019`**]\[[AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/3926)][56:fire:] Connecting the digital and physical world: Improving the robustness of adversarial attacks [**`Generative`**]\[[Code](https://github.com/stevetkjan/Digital2Physical)]
...
- \[**`2025`**\][[NeurIPS]](https://arxiv.org/abs/2510.04245) Concept-Based Masking: A Patch-Agnostic Defense Against Adversarial Patch Attacks
...
- \[**`2025`**\][[AAAI]](https://arxiv.org/abs/2509.24359) DRIFT: Divergent Response in Filtered Transformations for Robust Adversarial Defense
- \[**`2025`**\][[ACL]]( DiffuseDef: Improved Robustness to Adversarial Attacks via Iterative Denoising) DiffuseDef: Improved Robustness to Adversarial Attacks via Iterative Denoising
- \[**`2025`**\][[EMNLP]](https://aclanthology.org/2025.emnlp-main.1183/) Disentangled Information Bottleneck for Adversarial Text Defense
- \[**`2025`**\][[NeurIPS]](https://openreview.net/forum?id=VNbvk5pMS7) Adversary Aware Optimization for Robust Defense
- \[**`2025`**\][[TACL]](https://direct.mit.edu/tacl/article/doi/10.1162/TACL.a.43/133801) Adversarial Defense without Adversarial Defense: Enhancing Language Model Robustness via Instance-level Principal Component Removal
- \[**`2025`**\][[IEEE TIP]](https://ieeexplore.ieee.org/abstract/document/11021559/) OD-SHIELD: Convolutional Autoencoder-Based Defense Against Adversarial Patch Attacks in Object Detection
- \[**`2024`**\][[CVPR](https://openaccess.thecvf.com/content/CVPR2024/papers/Jing_PAD_Patch-Agnostic_Defense_against_Adversarial_Patch_Attacks_CVPR_2024_paper.pdf)] PAD: Patch-Agnostic Defense against Adversarial Patch Attacks [[Code](https://github.com/Lihua-Jing/PAD)]
...
- \[**`2025`**\][[CVPR]](https://openaccess.thecvf.com/content/CVPR2025/html/Wang_TAPT_Test-Time_Adversarial_Prompt_Tuning_for_Robust_Inference_in_Vision-Language_CVPR_2025_paper.html) TAPT: Test-Time Adversarial Prompt Tuning for Robust Inference in Vision-Language Models
...
- \[**`2021`**]\[[NeurIPS](https://arxiv.org/pdf/2012.12235.pdf)][35:fire:] Unadversarial examples: Designing objects for robust vision \[[Code](https://github.com/microsoft/unadversarial)][99:star:]
...
- \[**`2025`**\][[Arxiv]](https://arxiv.org/abs/2503.02169) One Stone, Two Birds: Enhancing Adversarial Defense Through the Lens of Distributional Discrepancy
- \[**`2025`**\][[Arxiv]](https://arxiv.org/abs/2506.05402) Lorica: A Synergistic Fine-Tuning Framework for Advancing Personalized Adversarial Robustness
- \[**`2025`**\][[TPAMI]](Defenses in Adversarial Machine Learning: A Systematic Survey From the Lifecycle Perspective) Defenses in Adversarial Machine Learning: A Systematic Survey From the Lifecycle Perspective
- \[**`2025`**\][[Nature Machine Intelligence]](https://www.cell.com/iscience/fulltext/S2589-0042(25)00921-6) Random heterogeneous spiking neural network for adversarial defense
- \[**`2025`**\][[TMLR]](Overcoming Open-Set Approaches to Adversarial Defense) Overcoming Open-Set Approaches to Adversarial Defense
...
- \[**`2025`**\][[ICML]](https://openreview.net/forum?id=D7qKAO34tp) Provably Cost-Sensitive Adversarial Defense via Randomized Smoothing
- \[**`2025`**\][[CVPR]](PatchDEMUX: A Certifiably Robust Framework for Multi-label Classifiers Against Adversarial Patches) PatchDEMUX: A Certifiably Robust Framework for Multi-label Classifiers Against Adversarial Patches
...
Our team is suuported by the **ZGC Lab** and the **DIG group** of the **State Key Laboratory of Complex & Critical Software Environment** ([SKLCCSE](https://ev.buaa.edu.cn/info/1035/1862.htm)), supervised Prof. [Xianglong Liu](https://xlliu-beihang.github.io/). The main research goals of our team is Security and Trustworthy AI.
...
[**Jin Hu**](https://hujincn.github.io)
